...
import com.liang.tabs.ripple.RippleUtils
import com.liang.tabs.utils.createColorStateList
import com.liang.tabs.utils.getColorFrom
import com.liang.tabs.utils.getColorStateList
...
//        Log.e("Item", "Item: ${position},updateColor: $offset")
    ...
    private fun updateBackgroundDrawable() {
        ...
        background = if (VERSION.SDK_INT >= 21) {
            RippleDrawable(
                rippleColor,
