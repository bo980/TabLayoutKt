...
class OperationActivity : AppCompatActivity() {
    ...
    private fun tabLayout() {
        ...
        RadioGroup.setOnCheckedChangeListener { _: RadioGroup, i: Int ->
            when (i) {
                R.id.RadioButton -> jTabLayout.mode = (TabLayout.MODE_FIXED)
                R.id.RadioButton1 -> jTabLayout.mode = (TabLayout.MODE_SCROLLABLE)
            }
        }
        ...
        button2.setOnClickListener {
            ...
            if (position.isEmpty()) {
                ...
                if (withViewPager) {
                    ...
                    if (jTabLayout.getTabCount() > Integer.parseInt(position)) {
                        jTabLayout.removeTabAt(Integer.parseInt(position))
                        inx = jTabLayout.getTabCount()
                    }
                }
            }
        ...
        jTabLayout.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
